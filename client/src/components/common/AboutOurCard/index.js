...
const AboutOurCard = ({ title, content, number }) => {
    return (
        <div className="relative w-full h-[178px] border py-[15px] px-[15px] rounded-tr-3xl rounded-bl-3xl overflow-hidden border-blue-500">
            ...
            <div>
                <h3 className="text-[34px] font-semibold">
                    <span className="text-gradient">{`0${number}`}</span>
                </h3>
                <div>
