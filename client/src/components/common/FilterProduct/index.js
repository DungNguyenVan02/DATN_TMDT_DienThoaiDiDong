...
const FilterProduct = ({ location, navigate }) => {
    ...
    const handleCheckedCategory = (e) => {
        ...
        if (categoryChecked.includes(category)) {
            setCategoryChecked((prev) => prev.filter((item) => item !== category));
        } else {
        ...
        if (price.length > 0) {
            ...
            switch (priceChecked?.length) {
                case 2:
                    ...
                    break;
                case 3:
                    dataSelected[priceChecked[0]] = priceChecked[1]?.split('|')[0];
                    dataSelected[priceChecked[1].split('|')[1]] = priceChecked[2];
                    break;
                default:
        ...
        <div className="w-full">
            ...
            <div className=" flex flex-col   mt-9 w-full">
                <div className="border-b py-5">
                    <h3 className="text-[16px] uppercase font-semibold">Giá sản phẩm</h3>
                    <div className="flex gap-3 flex-col justify-between w-full">
                        <div className="flex justify-between w-full">
                            <span>0 selected</span>
                            <span className="cursor-pointer hover:text-blue-500">Reset</span>
                        </div>
                        <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-1">
                                <input
                                    id="price-1"
                                    checked={price.includes('price[lte]:3000000')}
                            ...
                            <div className="flex items-center gap-1">
                                <input
                                    id="price-2"
                                    checked={price.includes('price[gte]:3000000|price[lte]:7000000')}
                                    className="w-[18px] h-[18px]"
                                    value="price[gte]:3000000|price[lte]:7000000"
                                    onChange={(e) => handleCheckedPrice(e)}
                                    type="checkbox"
                                />
                                <label htmlFor="price-2">Từ 3 triệu đến 7 triệu</label>
                            </div>
                            <div className="flex items-center gap-1">
                                <input
                                    id="price-3"
                                    checked={price.includes('price[gte]:7000000|price[lte]:10000000')}
                                    className="w-[18px] h-[18px]"
                                    value="price[gte]:7000000|price[lte]:10000000"
                                    onChange={(e) => handleCheckedPrice(e)}
                                    type="checkbox"
                                />
                                <label htmlFor="price-3">Từ 7 triệu đến 10 triệu</label>
                            </div>
                            <div className="flex items-center gap-1">
                                <input
                                    id="price-4"
                                    checked={price.includes('price[gte]:10000000|price[lte]:15000000')}
                                    className="w-[18px] h-[18px]"
                                    value="price[gte]:10000000|price[lte]:15000000"
                                    onChange={(e) => handleCheckedPrice(e)}
                                    type="checkbox"
                                />
                                <label htmlFor="price-4">Từ 10 triệu đến 15 triệu</label>
                            </div>
                            <div className="flex items-center gap-1">
                                <input
                                    id="price-5"
                                    checked={price.includes('price[gte]:15000000')}
                                    className="w-[18px] h-[18px]"
                ...
                <div className="border-b py-5">
                    <h3 className="text-[16px] uppercase font-semibold">Loại sản phẩm</h3>
                    <div className="flex gap-3 flex-col justify-between w-full">
                        <div className="flex justify-between w-full">
                            <span>0 selected</span>
                            <span className="cursor-pointer hover:text-blue-500">Reset</span>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center gap-1">
                                <input
                                    ...
                                    type="checkbox"
                                />
                                <label htmlFor="category-2">Máy tính bảng</label>
                            </div>
                            <div className="flex items-center gap-1">
                                <input
                                    id="category-3"
                ...
                <div className="border-b py-5">
                    <h3 className="text-[16px] uppercase font-semibold">Hãng sản phẩm</h3>
                    <div className="flex gap-3 flex-col justify-between w-full">
                        <div className="flex justify-between w-full">
                            <span>0 selected</span>
                            <span className="cursor-pointer hover:text-blue-500">Reset</span>
                ...
                <div className="border-b py-5">
                    <h3 className="text-[16px] uppercase font-semibold">Màu sắc</h3>
                    <div className="flex gap-3 flex-col justify-between w-full">
                        <div className="flex justify-between w-full">
                            <span>0 selected</span>
                            <span className="cursor-pointer hover:text-blue-500">Reset</span>
