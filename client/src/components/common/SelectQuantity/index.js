...
const SelectQuantity = ({ quantity, handleQuantity, handleChangeQuantity, customStyle }) => {
    ...
    return (
        <div className={` ${customStyle ? customStyle : 'flex items-center justify-center my-6 text-[24px]'}  `}>
            <span
            ...
            <input
                className="text-center outline-none w-[50px] h-[32px] border text-[16px] bg-black"
                value={quantity}
                min="1"
                type="number"
